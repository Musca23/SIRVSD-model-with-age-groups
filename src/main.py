...
if __name__ == "__main__":
    ...
    # plt.plot_all_compartments_entire_population(t, group_dict, results_dict, END-START+1)   
    ...
    # path = "../plots/"
    # plt.plot_pie_chart_zero_day(group_dict, "no_vaccination", results_dict, 1, END-START+1)
    ...
    # plt.plot_specific_compartment_compare_strategy(t, results_dict, 1, END-START+1)

    # ----- Stacked Bar Chart to compare mortality with different vaccination strategies ----
    # path = "../plots/strategy_comparison"
    # plt.plot_bar_chart_compartment_compare_strategy(group_dict, results_dict, vaccination_dict, 4, END-START+1)
